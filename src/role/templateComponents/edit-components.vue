  ...
  <div>
    ...
    >
      ...
      <div slot="footer">
        ...
        <Button type="primary" @click="handleSubmit('addForm')">提交修改</Button>
      </div>
    </Modal>
  </div>
</template>
<script>
  ...
  //  import { roleUrl } from './../../../config/site-config.js'
  import o from 'o.js'
  import Vue from 'vue'
  export default {
    data () {
      ...
      handleSubmit (formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            const apiUrl = Vue.$baseUrl.roleUrl + `/RoleTemplate(${_self.dataMsg.Id})/WUCC.Update`
            o(apiUrl).post({
              RoleTemplate: {
